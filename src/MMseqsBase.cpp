...
std::vector<Command> baseCommands = {
        ...
        {"search",               search,               &par.searchworkflow,       COMMAND_MAIN,
                ...
                CITATION_MMSEQS2 | CITATION_GPU, {{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                           ...
                                                           {"tmpDir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory }}},
        {"split-search",               splitsearch,               &par.splitsearchworkflow,       COMMAND_MAIN|COMMAND_EXPERT,
                "Sensitive homology search with multiple targetDBs",
                "# Search multiple FASTA against FASTA (like BLASTP, TBLASTN, BLASTX, BLASTN --search-type 3, TBLASTX --search-type 2)\n"
                "mmseqs split-search queryDB targetDB1 ... targetDBN resultDB_base tmp\n"
                "mmseqs convertalis queryDB targetDB resultDB result.m8\n\n"
                "# Iterative profile search (like PSI-BLAST)\n"
                "mmseqs split-search queryDB targetDB resultDB tmp --num-iterations 2\n\n",
                "Martin Steinegger <martin.steinegger@snu.ac.kr>, Sukhwan Park <pskvins@snu.ac.kr>",
                "<i:queryDB> <i:targetDB1> ... <i:targetDBN> <o:alignmentDB_base> <tmpDir>",
                CITATION_MMSEQS2 | CITATION_GPU, {{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                        {"targetDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC, &DbValidator::sequenceDb },
                                                        {"alignmentDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::alignmentDb },
                                                        {"tmpDir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory }}},
...
//                "Low. complex regions are masked as lower case characters. The remaining regions are printed as upper case characters.",
        ...
        {"result2msa",           result2msa,           &par.result2msa,           COMMAND_RESULT,
                ...
                CITATION_MMSEQS2,{{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                          ...
                                          {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::resultDb },
                                          {"msaDB",    DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::msaDb }}},
        {"results2msa",           results2msa,           &par.results2msa,           COMMAND_RESULT,
                "Compute MSA DB from multiple result DBs",
                NULL,
                "Martin Steinegger (martin.steinegger@snu.ac.kr) & Milot Mirdita <milot@mirdita.de> & Clovis Galiez",
                "<i:queryDB> <i:targetDB1> ... <i:targetDBN> <i:resultDB1> ... <i:resultDBN> <o:msaDB>",
                CITATION_MMSEQS2,{{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                        {"targetDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC, NULL },
                                        {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC, NULL },
                                        {"msaDB",    DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::msaDb }}},
        ...
        {"result2profile",       result2profile,       &par.result2profile,       COMMAND_PROFILE,
                ...
                CITATION_MMSEQS2,{{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                           ...
                                                           {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::resultDb },
                                                           {"profileDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::profileDb }}},
        {"results2profile",       results2profile,       &par.results2profile,       COMMAND_PROFILE,
                "Compute profile DB from multiple target DBs and result DBs",
                NULL,
                "Martin Steinegger <martin.steinegger@snu.ac.kr>, Sukhwan Park <pskvins@snu.ac.kr>",
                "<i:queryDB> <i:targetDB1> ... <i:targetDBN> <i:resultDB1> ... <i:resultDBN> <o:profileDB>",
                CITATION_MMSEQS2,{{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                        {"targetDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC, NULL },
                                                        {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::VARIADIC, NULL },
                                                        {"profileDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::profileDb }}},
